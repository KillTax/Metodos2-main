...
with tab1:
    ...
    st.markdown("El conjunto de los polinomios osculantes es una generalización de los polinomios de Taylor y los polinomios de Lagrange. Estos polinomios tienen la propiedad de que dados n + 1 números distintos x_0, x_1, x_2, ..., x_n y los enteros no negativos m_0, m_1, m_2, ..., m_n, el polinomio osculante que aproxima a una función f que pertenece a C^m[a, b], donde m = max(m_0, m_1, m_2, ..., m_n) y x_i pertenece a [a, b] para cada i = 0, 1, ..., n, es el polinomio de menor grado con la propiedad de que coincide con la función f y todas sus derivadas de orden menor o igual a m_i en x_i para cada i = 0, 1, ..., n. El grado de este polinomio osculante será a lo más.")
